...
const ServiceDetails = () => {
  return (
    <Layout>
      <PageBanner pageName={"Pergolas & Water Features"} />
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="service-info-wrapper pr-lg-40 wow fadeInDown">
                <h2 className="title">Pergolas &amp; Water Features</h2>
                <p>
                ...
                <p>
                  From the moment you say “yes” to exploring your garden’s potential, our design stage sets the tone: we listen carefully, sketch boldly, and refine precisely - wether it's installing a grand water feature or erecting a permanent pergola feature, we're the team best fit for making your dreams come to life.
                </p>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="navigation-item prev-post mb-40">
                      ...
                      <div className="text">
                        <h3 className="title">
                          <a href="/service-paving">Paving</a>
                        </h3>
                        <a href="/service-paving" className="btn-link">
                          Read More

...
const ServiceDetails = () => {
  return (
    <Layout>
      <PageBanner pageName={"Garden Design"} />
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="service-info-wrapper pr-lg-40 wow fadeInDown">
                <h2 className="title">Garden Design</h2>
                <p>
                ...
                <div className="block-image wow fadeInDown">
                  <img
                    src="assets/images/service/single-service3.jpg"
                    alt="Service Image"
                  />
                </div>
                ...
                <div className="block-image wow fadeInDown">
                  <img
                    src="assets/images/service/big1.jpg"
                    alt="Service Image"
                  />
                </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="navigation-item prev-post mb-40">
                      ...
                      <div className="text">
                        <h3 className="title">
                          <a href="/service-walls-turfing">Landscaping</a>
                        </h3>

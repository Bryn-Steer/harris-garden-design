...
const Index2 = () => {
  return (
    <Layout>
      <Head>
        <title>Garden Design & Landscaping in Warrington | Harris Garden Design</title>
        <meta
          name="description"
          content="Harris Garden Design provides premium garden design and landscaping services in Warrington, creating timeless outdoor spaces tailored to each property."
        />
      </Head>
